...
https://docs.spring.io/spring-cloud-stream/reference/rabbit/rabbit_overview.html[RabbitMQ]
or https://docs.spring.io/spring-cloud-stream/reference/kafka/kafka_overview.html[Kafka].
