...
`@ConfigurationProperties`. See the https://docs.spring.io/spring-cloud-commons/reference/{spring-cloud-version}/spring-cloud-commons/application-context-services.html#refresh-scope[Refresh Scope] documentation for
more information.
